<template>
  ...
  <div class="hidden w-60 lg:flex lg:flex-col items-center h-full pt-[68px] absolute border-r-[1px] border-neutral-300 dark:border-neutral-500">
    ...
    <button @click="onClickRegi" :class="{'bg-[#ededed] dark:bg-[#545454]':state.isregi,'bg-[#ffffff] dark:bg-[#444444]':!state.isregi}" class="flex items-center w-[14.5rem] text-sm my-[3px] py-4 px-4 h-10 overflow-hidden text-ellipsis whitespace-nowrap rounded hover:bg-neutral-200 dark:hover:bg-[#5f5f5f]">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
  ...
  <div class="fixed flex w-full flex-wrap bg-white dark:bg-[#444444] justify-center mt-[68px] space-x-4 items-center lg:hidden">
  ...
  <div class="pt-[115px] text-center mx-auto lg:hidden" >{{ store.state.lecture.lecInfo.title }}</div>

<template>
  <div v-if="props.publisher" class="flex items-center space-x-3">
    ...
    <UserCam class="h-full max-h-[135px]" :mainStreamManager="props.publisher"/>
    <UserCam class="h-full max-h-[135px]" v-for="sub in props.subscribers" :key="sub.stream.connection.connectionId" :mainStreamManager="sub"/>    
